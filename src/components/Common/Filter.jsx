...
import BeverageImage from "../../assets/Beverages/image (1).png";
import MuffinImage from "../../assets/Muffins/image (6).png";
import PizzaImage from "../../assets/Pizza/image (9).png";
import SnakesImage from "../../assets/Snacks/image (16).png";
import SmoothieImage from "../../assets/Beverages/image (16).png";
                      ...
                      {curr.subTopic.map((subtext) => {
                        return (
                          <button
                            ...
                            {subtext.apiName === "Vegan" ? <LuVegan id="filterProductImage--Ingredients-Vegan" /> : <img src={subtext.image} alt={subtext.text + "image"} id={subtext.apiName === "Veg" ? "filterProductImage--Ingredients-Veg" : "filterProductImage"} />}
                            <p>{subtext.text}</p>
              ...
              {showFilter.Category.concat(showFilter.Ingredients).map((curr, id) => {
                return (
                  <button className="btn" key={curr.text + id}>
                    {curr.apiName === "Vegan" ? <LuVegan id="filterProductImage--Ingredients-Vegan" /> : <img src={curr.image} alt={curr.text + "image"} id={curr.apiName === "Veg" ? "filterProductImage--Ingredients-Veg" : "filterProductImage"} />}
                    <p>{curr.text}</p>
                    <RiCloseFill
                      className="CutBTN"
                      onClick={() => {
